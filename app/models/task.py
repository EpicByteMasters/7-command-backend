...
class TaskStatus(BaseWithName):  # ready to use
    pass


class TaskFile(BaseWithName):  # ready to use
    url_link = Column(String())


class Task(BaseWithName):  # ready to use
...
class Education(BaseWithName):  # ready to use
