...
Revision ID: 4c732b5f7673
Revises: 
Create Date: 2024-01-18 23:33:02.652630
...
def upgrade():
    ...
    op.create_index(op.f('ix_user_supervisor_id'), 'user', ['supervisor_id'], unique=False)
    ...
    op.create_table('ipr',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('emplyee_id', sa.Integer(), nullable=True),
    sa.Column('supervisor_id', sa.Integer(), nullable=True),
...
def downgrade():
    ...
    op.drop_index(op.f('ix_user_supervisor_id'), table_name='user')
